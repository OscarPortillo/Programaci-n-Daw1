...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				System.out.println("Los días del mes son: " + fecha1.getDiasMes());
				System.out.println();
				break;
			case 2:
				...
				break;
			case 3:
				System.out.println(fecha1.getCadenaFecha1());
				break;
			case 4:
				System.out.println(fecha1.getCadenaFecha2());
				break;
			case 5:	
