...
*/
	public Boolean esIgual(Vehiculo otroVehiculo){
		Boolean sonIguales = true;// antes de empezar suponemos que son iguales
		if (this.numeroRuedas!=otroVehiculo.numeroRuedas){//si no tienen el mismo numero de ruedas
			sonIguales = false;//verdadera
		}else if(this.peso!=otroVehiculo.peso){//si no tienen el mismo peso
			sonIguales = false;
		}else if(this.velocidadMax!=otroVehiculo.velocidadMax){
			sonIguales = false;
		}else if(this.velocidadActual!=otroVehiculo.velocidadActual){
			sonIguales = false;
		}
		return sonIguales;
	}//esIgual
